...
## Further resources
- [Instruction Cycle](https://en.wikipedia.org/wiki/Instruction_cycle) (The process of fetching, decoding, and executing instructions)
- [Arithmetic Logic Unit](https://en.wikipedia.org/wiki/Arithmetic_logic_unit) (Component of CPU which does the actual calculations)
